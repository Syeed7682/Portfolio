        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left space-y-6">
            ...
            <div className="h-10 sm:h-12 flex items-center justify-center lg:justify-start">
              <div className="inline-flex items-center gap-2 text-xl sm:text-2xl lg:text-3xl font-semibold text-slate-800 dark:text-slate-200">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 text-xs text-slate-500 dark:text-slate-400 pt-1">
              <div className="flex items-center gap-1.5 bg-slate-100/70 dark:bg-slate-900/60 px-3 py-1.5 rounded-full border border-slate-200 dark:border-white/5">
