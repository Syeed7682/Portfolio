      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="p-6 rounded-3xl bg-slate-900/60 border border-white/10 backdrop-blur-xl space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-300">About Cover Image URL</label>
              <input
                type="text"
                value={aboutForm.coverImageUrl}
                onChange={(e) => setAboutForm(prev => ({ ...prev, coverImageUrl: e.target.value }))}
                className="w-full px-4 py-2 rounded-xl bg-slate-950/80 border border-white/10 text-xs text-white focus:outline-none focus:border-purple-500"
              />
            </div>
          </div>
